...
export {default as OngoingActive } from './ongoing-active.svg';
...
export {default as BookingActive } from './booking-active.svg';
...
export {default as PushNotify } from '../profile-icons/push-notification.svg';
...
export {default as HomeActive } from '../bottom-tab/home-active.svg';
export {default as TabSearchIcon } from '../bottom-tab/search.svg';
export {default as TabOngoingIcon } from '../bottom-tab/ongoing.svg';
export {default as TabProfileIcon } from '../bottom-tab/profile.svg';
export {default as Bell } from './bell.svg';
export {default as TotalHeader } from './total-header.svg';
...
export {default as Floating} from './floating.svg'
export {default as DotMenu} from './dot-menu.svg'
export {default as SelectedRadioButton} from './selected-radio.svg'
export {default as UnSelectedRadioButton} from './unselected-radio.svg'
export {default as SearchTwo} from './search-two.svg'
export {default as RightBlackArrow} from './right-black-arrow.svg'
export {default as LeftBlackArrow} from './left-black-arrow.svg'

export {default as VehicleTwo} from './vehicle-two.svg'
export {default as Water} from './water.svg'
export {default as HighlightedPercent} from './highlighted-percent.svg'
